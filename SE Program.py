...
class MovieDBApplication(Frame):
    def __init__(self, master):
        ...
        GoButton = Button(self.SearchFrame, text = "Go", font = ("Arial", 12, "bold"), command = lambda:self.SearchFilm(SearchEntry)) #add command
    ...
    def SearchFilm(self, title):
        ...
        key = '&apikey=e0ad0310'
        url = api + urllib.parse.urlencode({'t': title.get()}) + key
